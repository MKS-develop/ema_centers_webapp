...
function ReferenceAndCounterReference() {

    const { activeForm } = useMedicalRecordForm()

    let listOfInputs = [
        {title: "Referido por", value: "referidoPor"},
        {title: "Contrarreferido", value: "Contrarreferido"},
    ]

    return (
        <>
            <div className="w-full border-b h-fit pb-[1.5%]">
                <p className='font-semibold text-lg text-slate-900'>Referencia y contrarreferencia</p>
            </div>
...
export default ReferenceAndCounterReference