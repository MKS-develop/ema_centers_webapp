...
function AccidentPrevention() {

    const { activeForm } = useMedicalRecordForm()

    let listOfInputs = [
        {title: "Informa prevención accidentes", value: "informaPrevencionAccidentes"},
    ]

    return (
        <>
            <div className="w-full border-b h-fit pb-[1.5%]">
                <p className='font-semibold text-lg text-slate-900'>Prevención de accidentes</p>
            </div>
