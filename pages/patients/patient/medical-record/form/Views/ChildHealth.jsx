...
function ChildHealth() {
    ...
    let listOfInputs = [
        {title: "Niño sano RT", value: "ninoSanoRT"},
        {title: "Peso para talla", value: "pesoParaTalla"},
        {title: "Prueba EDI", value: "pruebaEDI"},
        {title: "Resultado EDI", value: "resultadoEDI"},
        {title: "Rsultado Battelle", value: "resultadoBattelle"}
    ]

    return (
        <>
            <div className="w-full border-b h-fit pb-[1.5%]">
                <p className='font-semibold text-lg text-slate-900'>Salud del niño</p>
            </div>
